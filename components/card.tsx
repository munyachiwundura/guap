...
const Card: FunctionComponent<Props> = (props) => {
  return (
    <motion.div layoutId={props.bank} className='snap-center relative text-white w-[135px] h-[85px] md:w-[335px] md:h-[185px] m-5 flex-shrink-0'>
        <Image alt={`Image of ${props.name}s ${props.bank} card`} width={335} height={185} src={`/img/cards/${props.bank}.svg`}/>
